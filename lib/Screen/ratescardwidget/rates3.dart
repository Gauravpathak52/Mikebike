...
class Rates3Screen extends StatelessWidget {
  const Rates3Screen({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildRateRow(
                  'Children (7-12 years, min height 130 cm)', 'RM 165'),
              _buildRateRow('Adults (13 years and older)', 'RM 185'),
              const Divider(),
              const Text(
              ...
              _buildRateRow('1 child', 'RM 205'),
              _buildRateRow('2 children', 'RM 195'),
              _buildRateRow('3 children or more (max. 6)', 'RM 185'),
              const Text('Adults (13 years and older):',
                  style: TextStyle(fontWeight: FontWeight.bold)),
              _buildRateRow('1 person', 'RM 310'),
              _buildRateRow('2 persons', 'RM 255'),
              _buildRateRow('3 persons', 'RM 230'),
              _buildRateRow('4 persons or more', 'RM 205'),
              const Divider(),
