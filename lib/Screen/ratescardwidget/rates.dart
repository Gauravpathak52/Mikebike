        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildRateRow(
                  'Children (7-12 years, min height 130 cm)', 'RM 190'),
              _buildRateRow('Adults (13 years and older)', 'RM 230'),
              const Divider(),
              const Text(
              ...
              _buildRateRow('1 child', 'RM 325'),
              _buildRateRow('2 children', 'RM 225'),
              _buildRateRow('3 children or more (max. 6)', 'RM 205'),
              const Text('Adults (13 years and older):',
                  style: TextStyle(fontWeight: FontWeight.bold)),
              _buildRateRow('1 person', 'RM 435'),
              _buildRateRow('2 persons', 'RM 330'),
              _buildRateRow('3 persons', 'RM 280'),
              _buildRateRow('4 persons or more', 'RM 260'),
              const Divider(),
