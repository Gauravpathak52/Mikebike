...
class Rates2Screen extends StatelessWidget {
  const Rates2Screen({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildRateRow(
                  'Children (7-12 years, min height 130 cm)', 'RM 270'),
              _buildRateRow('Adults (13 years and older)', 'RM 290'),
              const Divider(),
              const Text(
              ...
              _buildRateRow('1 child', 'RM 345'),
              _buildRateRow('2 children', 'RM 320'),
              _buildRateRow('3 children or more (max. 6)', 'RM 310'),
              const Text('Adults (13 years and older):',
                  style: TextStyle(fontWeight: FontWeight.bold)),
              _buildRateRow('1 person', 'RM 505'),
              _buildRateRow('2 persons', 'RM 400'),
              _buildRateRow('3 persons', 'RM 350'),
              _buildRateRow('4 persons or more', 'RM 320'),
              const Divider(),
